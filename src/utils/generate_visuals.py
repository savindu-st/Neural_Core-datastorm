...
def generate_charts():
    ...
    # 1. Feature Importance Chart (Removed to prevent duplicates with model_interpretability.py)
    # The feature_importance_chart.png generated by the interpretability module is more detailed.
